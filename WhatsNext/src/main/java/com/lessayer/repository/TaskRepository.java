...
public class TaskRepository {
	...
	public List<Task> findByUserId(long userId) {
		...
		query = entityManager.createNamedQuery("find_all_tasks_by_userID", Task.class).setParameter("userId", userId);
		return query.getResultList();
	...
	public Long returnTaskCount() {
		...
		countQuery = entityManager.createNamedQuery("return_number_of_tasks", Long.class);
